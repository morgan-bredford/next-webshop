      ...
      {cart.length ? (
        <section>
          {cart.map((product, index) => {
            return (
              <section className={styles.cart_item} key={product._id}>
                <img
          ...
          <section className={styles.cart_total_price}>
            Totalpris: {totalCost}
            <span className="currency">kr</span>
          </section>
          <section className={styles.cart_emptyingcart} onClick={emptyCart}>
            Töm korgen
          </section>
        </section>
      ) : (
        <div className={styles.cart_empty_cart}>
